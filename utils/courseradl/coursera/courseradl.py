...
def simple_course_download(username, password, course, path):
    """
    A simple function to facilitate the download of a single course using the library as a module
    """
    ...
    wget=None)
    args.class_names.append(course)
